...
public sealed record ReadFreshnessMetricsSummary
{
    ...
    public double? StaleRequestFraction
    {
        get; init;
    }

    public int ComparedResultCount
    {
        get; init;
    }
    ...
    public double? StaleResultFraction
    {
        get; init;
    }

    public double? AverageMaxStalenessAgeMs
    {
        get; init;
    }

    public double? MaxObservedStalenessAgeMs
    {
        get; init;
    }

    public IReadOnlyList<ReadSourceFreshnessMetricsSummary> Sources
    {
        get; init;
    } =
...
{
    public required string ReadSource
    {
        get; init;
    }
