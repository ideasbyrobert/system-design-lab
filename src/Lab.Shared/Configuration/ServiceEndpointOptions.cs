...
public sealed class ServiceEndpointOptions
{
    ...
    public string? CatalogRegion
    {
        get; set;
    }

    public string? CatalogFailoverBaseUrl
    {
        get; set;
    }

    public string? CatalogFailoverRegion
    {
        get; set;
    }
    ...
    public string? PaymentSimulatorRegion
    {
        get; set;
    }
}
