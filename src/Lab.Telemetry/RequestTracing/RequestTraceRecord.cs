...
public sealed record class RequestTraceRecord
{
    ...
    public required DateTimeOffset ArrivalUtc
    {
        get; init;
    }

    public required DateTimeOffset StartUtc
    {
        get; init;
    }

    public required DateTimeOffset CompletionUtc
    {
        get; init;
    }

    public required double LatencyMs
    {
        get; init;
    }
    ...
    public required bool ContractSatisfied
    {
        get; init;
    }
    ...
    public required bool RateLimited
    {
        get; init;
    }
