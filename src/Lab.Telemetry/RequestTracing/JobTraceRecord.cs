...
public sealed record class JobTraceRecord
{
    ...
    public required DateTimeOffset EnqueuedUtc
    {
        get; init;
    }

    public DateTimeOffset? DequeuedUtc
    {
        get; init;
    }

    public DateTimeOffset? ExecutionStartUtc
    {
        get; init;
    }

    public DateTimeOffset? ExecutionEndUtc
    {
        get; init;
    }
