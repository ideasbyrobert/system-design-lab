# Analysis Report: milestone-4-sync-slow-success

Generated: `2026-04-01T08:51:17.6942830+00:00`
...
- Filter run id: `milestone-4-sync-slow-success`
- Filter from: `n/a`
- Filter to: `n/a`
- Filter operation: `payment-authorize`
- Included run ids: `milestone-4-sync-slow-success`

## Queue State Snapshot

| Metric | Value |
| --- | --- |
| Snapshot time | `2026-04-01T08:51:17.6942830+00:00` |
| Queue run-id filter | `milestone-4-sync-slow-success` |
| Pending count | 1 |
| Ready count | 1 |
| Delayed count | 0 |
| In-progress count | 0 |
| Completed count | 0 |
| Failed count | 0 |
| Oldest queued enqueued UTC | `2026-04-01T08:51:15.9131720+00:00` |
| Oldest queued item age (ms) | 1781.111 |
...
| Window start | `2026-04-01T08:51:15.4099190+00:00` |
| Window end | `2026-04-01T08:51:15.9111900+00:00` |
| Window duration (ms) | 501.271 |
| Average latency (ms) | 501.267 |
| P50 latency (ms) | 501.267 |
| P95 latency (ms) | 501.267 |
| P99 latency (ms) | 501.267 |
| Throughput (req/s) | 1.995 |
...
The live queue snapshot shows `1` pending jobs, `0` in progress, and an oldest queued age of `1781.111` ms.
