# Analysis Report: milestone-4-sync-timeout

Generated: `2026-04-01T08:51:23.0929830+00:00`
...
- Filter run id: `milestone-4-sync-timeout`
- Filter from: `n/a`
- Filter to: `n/a`
- Filter operation: `payment-authorize`
- Included run ids: `milestone-4-sync-timeout`

## Queue State Snapshot

| Metric | Value |
| --- | --- |
| Snapshot time | `2026-04-01T08:51:23.0929830+00:00` |
| Queue run-id filter | `milestone-4-sync-timeout` |
| Pending count | 1 |
| Ready count | 1 |
| Delayed count | 0 |
| In-progress count | 0 |
| Completed count | 0 |
| Failed count | 0 |
| Oldest queued enqueued UTC | `2026-04-01T08:51:21.2865960+00:00` |
| Oldest queued item age (ms) | 1806.387 |
...
| Window start | `2026-04-01T08:51:18.2821510+00:00` |
| Window end | `2026-04-01T08:51:21.2851360+00:00` |
| Window duration (ms) | 3002.985 |
| Average latency (ms) | 3002.961 |
| P50 latency (ms) | 3002.961 |
| P95 latency (ms) | 3002.961 |
| P99 latency (ms) | 3002.961 |
| Throughput (req/s) | 0.333 |
| Average concurrency | 1 |
| Rate-limited fraction | 0% |
| Cache hit rate | 0% |
| Cache miss rate | 100% |
| Errors by status | `504=1` |
...
| Reject fraction | 0% |
| Timeout request count | 1 |
| Timeout fraction | 100% |
...
`1` admitted requests still timed out, which means protection did not eliminate slow-path failure inside the admitted set.

The live queue snapshot shows `1` pending jobs, `0` in progress, and an oldest queued age of `1806.387` ms.
