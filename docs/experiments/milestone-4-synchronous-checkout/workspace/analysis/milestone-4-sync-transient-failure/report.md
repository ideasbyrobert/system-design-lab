# Analysis Report: milestone-4-sync-transient-failure

Generated: `2026-04-01T08:51:25.4793190+00:00`
...
- Included run ids: `milestone-4-sync-transient-failure`

## Queue State Snapshot

| Metric | Value |
| --- | --- |
| Snapshot time | `2026-04-01T08:51:25.4793190+00:00` |
| Queue run-id filter | `milestone-4-sync-transient-failure` |
| Pending count | 1 |
| Ready count | 1 |
| Delayed count | 0 |
| In-progress count | 0 |
| Completed count | 0 |
| Failed count | 0 |
| Oldest queued enqueued UTC | `2026-04-01T08:51:23.6970440+00:00` |
| Oldest queued item age (ms) | 1782.275 |
...
| Window start | `2026-04-01T08:51:23.6693350+00:00` |
| Window end | `2026-04-01T08:51:23.6957670+00:00` |
| Window duration (ms) | 26.432 |
| Average latency (ms) | 26.432 |
| P50 latency (ms) | 26.432 |
| P95 latency (ms) | 26.432 |
| P99 latency (ms) | 26.432 |
| Throughput (req/s) | 37.833 |
| Average concurrency | 1 |
| Rate-limited fraction | 0% |
| Cache hit rate | 0% |
| Cache miss rate | 100% |
| Errors by status | `503=1` |
...
The live queue snapshot shows `1` pending jobs, `0` in progress, and an oldest queued age of `1782.275` ms.
