# Analysis Report: milestone-9-local-catalog-unavailable

Generated: `2026-04-01T08:55:29.1854720+00:00`

## Inputs

- Requests file: `/Users/robertkarapetyan/git/project/source/ecommerce-systems-lab/docs/experiments/milestone-9-degraded-mode-failover/workspace/local-catalog-unavailable/logs/requests.jsonl`
- Jobs file: `/Users/robertkarapetyan/git/project/source/ecommerce-systems-lab/docs/experiments/milestone-9-degraded-mode-failover/workspace/local-catalog-unavailable/logs/jobs.jsonl`
- Filter run id: `milestone-9-local-catalog-unavailable`
- Filter from: `n/a`
- Filter to: `n/a`
- Filter operation: `product-page`
- Included run ids: `milestone-9-local-catalog-unavailable`

## Queue State Snapshot

| Metric | Value |
| --- | --- |
| Snapshot time | `2026-04-01T08:55:29.1854720+00:00` |
| Queue run-id filter | `milestone-9-local-catalog-unavailable` |
| Pending count | 0 |
| Ready count | 0 |
| Delayed count | 0 |
| In-progress count | 0 |
...
| Window start | `2026-04-01T08:55:23.1942110+00:00` |
| Window end | `2026-04-01T08:55:28.5314750+00:00` |
| Window duration (ms) | 5337.264 |
| Average latency (ms) | 10.182 |
| P50 latency (ms) | 0.226 |
| P95 latency (ms) | 58.754 |
| P99 latency (ms) | 79.299 |
| Throughput (req/s) | 8.993 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `primary` | 48 | 0 | 0% | 10.182 | 58.754 | n/a | n/a |
