# Analysis Report: milestone-9-healthy-west-local

Generated: `2026-04-01T08:55:05.4712270+00:00`
...
- Included run ids: `milestone-9-healthy-west-local`

## Queue State Snapshot

| Metric | Value |
| --- | --- |
| Snapshot time | `2026-04-01T08:55:05.4712270+00:00` |
| Queue run-id filter | `milestone-9-healthy-west-local` |
| Pending count | 0 |
| Ready count | 0 |
| Delayed count | 0 |
| In-progress count | 0 |
...
| Window start | `2026-04-01T08:54:59.4123280+00:00` |
| Window end | `2026-04-01T08:55:04.7776110+00:00` |
| Window duration (ms) | 5365.283 |
| Average latency (ms) | 7.425 |
| P50 latency (ms) | 0.229 |
| P95 latency (ms) | 43.899 |
| P99 latency (ms) | 65.132 |
| Throughput (req/s) | 8.946 |
| Average concurrency | 0.066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `replica-west` | 48 | 0 | 0% | 7.425 | 43.899 | n/a | n/a |
...
The request window carried `0.066` requests in flight on average, reconstructed exactly from observed lifetimes instead of thread counts.
