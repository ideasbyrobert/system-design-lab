# Analysis Report: milestone-9-west-local

Generated: `2026-04-01T08:54:40.3349760+00:00`

## Inputs

- Requests file: `/Users/robertkarapetyan/git/project/source/ecommerce-systems-lab/docs/experiments/milestone-9-same-region-vs-cross-region/workspace/west-local/logs/requests.jsonl`
- Jobs file: `/Users/robertkarapetyan/git/project/source/ecommerce-systems-lab/docs/experiments/milestone-9-same-region-vs-cross-region/workspace/west-local/logs/jobs.jsonl`
- Filter run id: `milestone-9-west-local`
- Filter from: `n/a`
- Filter to: `n/a`
- Filter operation: `product-page`
- Included run ids: `milestone-9-west-local`

## Queue State Snapshot

| Metric | Value |
| --- | --- |
| Snapshot time | `2026-04-01T08:54:40.3349760+00:00` |
| Queue run-id filter | `milestone-9-west-local` |
| Pending count | 0 |
| Ready count | 0 |
| Delayed count | 0 |
| In-progress count | 0 |
...
| Window start | `2026-04-01T08:54:34.3498380+00:00` |
| Window end | `2026-04-01T08:54:39.7061450+00:00` |
| Window duration (ms) | 5356.307 |
| Average latency (ms) | 7.059 |
| P50 latency (ms) | 0.229 |
| P95 latency (ms) | 44.386 |
| P99 latency (ms) | 53.953 |
| Throughput (req/s) | 8.961 |
| Average concurrency | 0.063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `replica-west` | 48 | 0 | 0% | 7.059 | 44.386 | n/a | n/a |
...
The request window carried `0.063` requests in flight on average, reconstructed exactly from observed lifetimes instead of thread counts.
